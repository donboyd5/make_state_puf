...
setdiff_all <- function(v1, v2){
  # v1, v2: 2 vectors of the same type
  # which elements are not in both vectors?
...
# readRDS(paste0(globals$tcdir, globals$statedir, "puf2017_unweighted.rds"))

# TO COME ----
# run the file through tax calculator to get 2017 AGI

# add national weights consistent with total US agi

# mechanically construct ratio-adjusted state weights for the state in question, as a starting point
